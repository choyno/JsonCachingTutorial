...
public class Ref {
	...
	public static final String GETALLTEACHERS = "SpApiGetAllTeachers";
	public static final String GETNEWTEACHERS = "SpApiGetNewTeachers";
	public static final String GETPOPULARTEACHERS = "SpApiGetPopularTeachers"; 
	...
	// No of all incoming lessons
	public static int NO_ALARM_NOTIFICATION = 0;
